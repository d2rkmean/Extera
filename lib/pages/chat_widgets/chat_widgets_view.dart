            ...
            children: [
              StreamBuilder(
                stream: client.onRoomState.stream
                    .where((event) => event.roomId == controller.widget.roomId)
